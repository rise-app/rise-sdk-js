...
export class ChannelAuth extends ApiClass {
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/token',
    validator: auth[ACTIONS.GET_SESSION_USER]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session',
    validator: auth[ACTIONS.GET_SESSION_USER]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/cart',
    validator: auth[ACTIONS.GET_SESSION_CART]
  })
  ...
  /**
   * Change the Current Session's Cart to a different Cart that the Session's User can use
   * @param data
   * @param req
   * @param validated
   */
  @Action({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/cart_current',
    validator: auth[COMMANDS.CHANGE_SESSION_CART]
  })
  changeSessionCart(data, req?, validated?) {
    return this.request(req, data, validated)
  }
  ...
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/cart',
    validator: auth[COMMANDS.UPDATE_SESSION_CART]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/cart/items',
    validator: auth[ACTIONS.LIST_SESSION_CART_ITEMS]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/session/cart/items',
    validator: auth[COMMANDS.CREATE_SESSION_CART_ITEM]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/cart/items/:item_uuid',
    validator: auth[ACTIONS.GET_SESSION_CART_ITEM]
  })
  ...
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/cart/items/:item_uuid',
    validator: auth[COMMANDS.UPDATE_SESSION_CART_ITEM]
  })
  ...
  @Command({
    method: 'DELETE',
    route: 'channels/:channel_uuid/auth/session/cart/items/:item_uuid',
    validator: auth[COMMANDS.REMOVE_SESSION_CART_ITEM]
  })
  ...
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/cart/checkout',
    validator: auth[COMMANDS.CHECKOUT_SESSION_CART]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer',
    validator: auth[ACTIONS.GET_SESSION_CUSTOMER]
  })
  ...
  /**
   * Change the Current Session's Customer to a different Customer that the Session's User is allowed to use
   * @param data
   * @param req
   * @param validated
   */
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/customer_current',
    validator: auth[COMMANDS.CHANGE_SESSION_CUSTOMER]
  })
  changeSessionCustomer(data, req?, validated?) {
    return this.request(req, data, validated)
  }
  ...
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/customer',
    validator: auth[COMMANDS.UPDATE_SESSION_CUSTOMER]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/carts',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_CARTS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/feeds',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_FEEDS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/accounts',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_ACCOUNTS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/sources',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_SOURCES]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/orders',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_ORDERS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/orders/:order_uuid',
    validator: auth[ACTIONS.GET_SESSION_CUSTOMER_ORDER]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/orders/:order_uuid/items',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_ORDER_ITEMS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/customer/users',
    validator: auth[ACTIONS.LIST_SESSION_CUSTOMER_USERS]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/roles',
    validator: auth[ACTIONS.LIST_SESSION_ROLES]
  })
  ...
  @Action({
    method: 'GET',
    route: 'channels/:channel_uuid/auth/session/user',
    validator: auth[ACTIONS.GET_SESSION_USER]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/local/register',
    validator: auth[COMMANDS.REGISTER_USER]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/local',
    validator: auth[COMMANDS.LOGIN_USER]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/logout',
    validator: auth[COMMANDS.LOGOUT_USER]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/recover',
    validator: auth[COMMANDS.SET_RECOVERY]
  })
  ...
  @Command({
    method: 'POST',
    route: 'channels/:channel_uuid/auth/local/recover',
    validator: auth[COMMANDS.RECOVER]
  })
  ...
  @Command({
    method: 'PUT',
    route: 'channels/:channel_uuid/auth/session/user',
    validator: auth[COMMANDS.UPDATE_SESSION_USER]
  })
