...
export const feed = {
   ...
   */
  [ACTIONS.LIST_FEEDS]: {
    params: (data) => Utils.joiPromise(data, feedSchema.actions[ACTIONS.LIST_FEEDS].params)
  },
   ...
   */
  [ACTIONS.GET_FEED]: {
    params: (data) => Utils.joiPromise(data, feedSchema.actions[ACTIONS.GET_FEED].params)
  },
