export const CUSTOMER_COMMANDS = {
  ...
  'ADD_CUSTOMER_CHILD': 'add.channel.:channel_uuid.customer.:customer_uuid.child',
  'MOVE_CUSTOMER_CHILD': 'move.channel.:channel_uuid.customer.:customer_uuid.child',
  'REMOVE_CUSTOMER_CHILD': 'remove.channel.:channel_uuid.customer.:customer_uuid.child',
  ...
  'SET_CUSTOMER_FEED': 'set.channel.:channel_uuid.customer.:customer_uuid.feed',

  'UPLOAD_CUSTOMERS': 'upload.channel.:channel_uuid.list.customer',
  'PROCESS_UPLOADED_CUSTOMERS': 'process.upload.channel.:channel_uuid.list.customer',
...
export const CUSTOMER_EVENTS = {
  ...
  'CUSTOMERS_UPLOADED': 'channel.:channel_uuid.customer.uploaded.list',
  'CUSTOMERS_UPLOAD_PROCESSED': 'channel.:channel_uuid.customer.:customer_uuid.upload.processed.list',
  ...
  'CUSTOMER_CHILD_ADDED': 'channel.:channel_uuid.customer.:customer_uuid.child.added',
  'CUSTOMER_CHILD_MOVED': 'channel.:channel_uuid.customer.:customer_uuid.child.moved',
  'CUSTOMER_CHILD_REMOVED': 'channel.:channel_uuid.customer.:customer_uuid.child.removed',
